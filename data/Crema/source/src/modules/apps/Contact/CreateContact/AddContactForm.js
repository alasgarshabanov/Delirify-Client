  ...
  return (
    <Form className='' noValidate autoComplete='off'>
      <Box
        ...
        <Box component='h4' fontFamily={Fonts.MEDIUM}>
          {values.name}
        </Box>
      </Box>
      ...
      <Scrollbar style={{maxHeight: 600}}>
        <Box py={5} px={{xs: 5, lg: 8, xl: 10}}>
          ...
          <Box>
            <Box component='h6' mb={2} fontFamily={Fonts.MEDIUM} fontSize={16}>
        ...
        <Box
          ...
          <Button className={classes.btnRoot} color='secondary' type='submit'>
